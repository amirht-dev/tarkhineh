...
export const Heart_Outline = forwardRef<
  SVGSVGElement,
...
Heart_Outline.displayName = "Heart_Outline";

export const Heart_Bold = forwardRef<
  SVGSVGElement,
  ComponentPropsWithoutRef<"svg">
>((props, ref) => {
  return (
...
Heart_Bold.displayName = "Heart_Bold";

const Heart = { Outline: Heart_Outline, Bold: Heart_Bold };

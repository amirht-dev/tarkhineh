...
export const User_Outline = forwardRef<
  SVGSVGElement,
...
User_Outline.displayName = "User_Outline";

export const User_Bold = forwardRef<
  SVGSVGElement,
  ComponentPropsWithoutRef<"svg">
>((props, ref) => {
  return (
...
User_Bold.displayName = "User_Bold";

const User = { Outline: User_Outline, Bold: User_Bold };

...
export const ShoppingCard_Outline = forwardRef<
  SVGSVGElement,
...
ShoppingCard_Outline.displayName = 'ShoppingCard_Outline';

export const ShoppingCard_Bold = forwardRef<
  SVGSVGElement,
  ComponentPropsWithoutRef<'svg'>
>((props, ref) => {
  return (
...
ShoppingCard_Bold.displayName = 'ShoppingCard_Bold';

const ShoppingCard = { Outline: ShoppingCard_Outline, Bold: ShoppingCard_Bold };
